...
const SOLID_TILES = new Set([
  ...
  // Trees + bushes (not autumn variants 9,10,21,22 — those removed from map)
  5,7,8,19,20,27,28,
  // Fences
...
const MAP_DATA: number[][] = [
  ...
  // Row 12 — south building approach (grass + fenced yard)
  [T.GRASS,T.GRASS,T.GRASS,T.GRASS,T.FENCE_TL,T.FENCE_T,T.FENCE_T,T.FENCE_T,T.FENCE_TR,T.GRASS,T.GRASS,T.GRASS,T.GRASS,T.GRASS,T.GRASS,T.GRASS,T.GRASS,T.GRASS,T.GRASS_F1,T.GRASS,T.GRASS,T.GRASS,T.GRASS,T.GRASS],
  // Row 13 — south building roofs
  [T.GRASS,T.ROOF_TL,T.ROOF_T,T.ROOF_TR,T.FENCE_L,T.GRASS_F2,T.GRASS,T.GRASS,T.FENCE_R,T.GRASS,T.ROOFRED_TL,T.ROOFRED_T,T.ROOFRED_T,T.ROOFRED_TR,T.GRASS,T.GRASS,T.GRASS,T.ROOF_TL,T.ROOF_T,T.ROOF_TR,T.GRASS,T.GRASS,T.GRASS,T.GRASS],
  // Row 14
